...
public class FileService {
	 ...
	 * 
	 * C:\Users\ user1\Desktop\Java_PDF
	 * 
	 * 경로 표기 방법 (하위 폴더)
	 * Windos    : \ (백슬래시)
	 * Linux/Mac : / (슬래시)
	 * 
	 * -> Java 는 모든 운영체제가 호환되기 때문에
	 * 	  경로 표기 방법도 모두 호한된다!
	 * 
	 * 최상위 경로(root) : / 또는 \
	 * - Windows   : C 드라이브, D 드라이브 ...
	 * - Linux/Mac : /, /Users
	 * 
	 * 
	 */
...
//			마지막으로 수정한 날짜
//			-> 1970.01.01 09:00:00.00 기준으로 지난 시간 (ms 단위)
...
//				Byte -> KB 변경
				...
				if (size < 1) size = 1;  // 1KB 미만은 1 로 표시
