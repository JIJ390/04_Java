 ...
 *   
 *       - public 필드 
 *       	-> 같은 프로젝트 내 어디서든 해당 클래스를 이용해
 *       		만들어진 객체의 public 필드를 직접 접근 가능
 *       
 *   2) [#] protected : 같은 패키지 or 상속 관계에서만 접근 가능
 *   		
 *   		- protected 필드
 ...
 *   
 *   		- (default) 필드
 *   			-> 같은 패키지 내에서 해당 클래스를 이용해서 만들어진 객체의
 *   				(default) 필드 직접 접근 가능
 *   
...
public class FieldTest1 {
	...
	public void method() {
		...
		System.out.println(defaultVaule);
