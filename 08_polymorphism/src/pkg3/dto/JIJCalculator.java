...
public class JIJCalculator implements Calculator{
	...
	public String toBinary(int num) {
		...
		if (num > MAX_NUM) return Integer.toBinaryString(MAX_NUM);
		if (num < MIN_NUM) return Integer.toBinaryString(MIN_NUM);
		return Integer.toBinaryString(num);
	}

	@Override
	public String toHexadecimal(int num) {
		if (num > MAX_NUM) return Integer.toHexString(MAX_NUM);
		if (num < MIN_NUM) return Integer.toHexString(MIN_NUM);
