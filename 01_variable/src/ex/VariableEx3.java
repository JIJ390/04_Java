...
public class VariableEx3 {
	public static void main(String[] args) {
		...
		System.out.println(num2 - result2); 		// 0.45678900000000056
		// 소수점 부분은 2 진법으로 저장
		// 2진수 소수 표현 시 문제점, 무한소수로 나타나서?
		...
		System.out.println("ㄱ 의 번호 : " + (int)'ㄱ');	// 12593
		System.out.println("ㄱ 다음은? : " + (char)('ㄱ' + 1));	// ㄲ
		System.out.println("ㄱ + 2 은? : " + (char)('ㄱ' + 2));	// ㄳ
		System.out.println("ㄱ + 3 은? : " + (char)('ㄱ' + 3));	// ㄴ
		 ...
		 * [작성법]
		 * final 자료형 변수명 = 값;
		 * (진짜 진짜 마지막 파이널 라스트 최종 찐막 수정 ver 3.4)
		 * 
		 * -> 변수명은 대문자 + +형식으로 작성
		 */
		
		final double PI = 3.141592;
		final int NATIONAL_CODE = 82; // 국가코드
		
		// NATIONAL_CODE = 11;  오류 발생
